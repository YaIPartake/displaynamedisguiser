...
public interface DisplayNameDisguiserConfig extends Config
{
	@ConfigSection(
			...
			description = "Shows the text box to customize the names.",
			position = 1,
